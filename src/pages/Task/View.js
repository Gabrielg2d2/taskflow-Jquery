...
export default class TaskView {
  ...
  #templateClearAllTasksButton(disabledClearAllTasksButton) {
    return `
      <button data-js="task-clear" class="${styles.buttonClear} ${disabledClearAllTasksButton ? "" : styles.buttonClearDisabled}" ${disabledClearAllTasksButton ? "" : "disabled"} type="button">
